...
exports.activateColorDecorations = exports.updateDecoratorsWrapperDebounced = exports.updateDecoratorsWrapper = exports.findEditorByDocument = exports.updateDecorators = exports.normalizeColors = exports.getRealColumn = exports.buildCallValueFromArgs = exports.getColors = exports.extractColorsFromExpression = void 0;
...
const findEditorByDocument = document => vscode_1.window.visibleTextEditors.find(editor => editor.document.uri.toString() === document.uri.toString());
exports.findEditorByDocument = findEditorByDocument;
const updateDecoratorsWrapper = (colorsDecorationType, editor) => updateDecorators(colorsDecorationType, editor);
