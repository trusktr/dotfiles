...
PRs are always welcome. Please refer to [CONTRIBUTING.md](https://github.com/xsburg/vscode-javascript-booster/blob/master/CONTRIBUTING.md) for tips on how to build and debug.
