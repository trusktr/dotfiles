...
(function (PartType) {
    ...
    */
    PartType[PartType["ReactImportedCSSModuleName"] = 10] = "ReactImportedCSSModuleName";
    PartType[PartType["ReactImportedCSSModuleProperty"] = 11] = "ReactImportedCSSModuleProperty";
    /**
     * `import 'xxx.css'`
     * `styleName="class-name"`
    */
    PartType[PartType["ReactDefaultImportedCSSModuleClass"] = 12] = "ReactDefaultImportedCSSModuleClass";
    //// From CSS.
    /** Wrapper all other selector parts. */
    PartType[PartType["CSSSelectorWrapper"] = 13] = "CSSSelectorWrapper";
    /** div{...} */
    PartType[PartType["CSSSelectorTag"] = 14] = "CSSSelectorTag";
    /** It includes identifier `#`. */
    PartType[PartType["CSSSelectorId"] = 15] = "CSSSelectorId";
    /** It includes identifier `.`. */
    PartType[PartType["CSSSelectorClass"] = 16] = "CSSSelectorClass";
    /** `--variable-name: ...;` */
    PartType[PartType["CSSVariableDefinition"] = 17] = "CSSVariableDefinition";
    /** `-`, `--`, or `--property`, no value specified yet. */
    PartType[PartType["CSSVariableDefinitionNotComplete"] = 18] = "CSSVariableDefinitionNotComplete";
    /** `property: var(--variable-name);` */
    PartType[PartType["CSSVariableReference"] = 19] = "CSSVariableReference";
    /** `property: --variable-name`, only for completion. */
    PartType[PartType["CSSVariableReferenceNoVar"] = 20] = "CSSVariableReferenceNoVar";
