### Version 4.19.1
- Fixed slow update of statistics decorations (fixes [#210](https://github.com/fabiospampinato/vscode-todo-plus/issues/210)) (#367) (thanks to @squidfunk and @marvinhagemeister)
