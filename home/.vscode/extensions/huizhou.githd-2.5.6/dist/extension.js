...
var GitService = class {
  ...
  async getCommitsCount(repo, branch, author, startTime, endTime) {
    if (!repo) {
      return 0;
    }
...
var CommandCenter = class {
  constructor(context, _model, _loader, _gitService, _historyView, _explorerView) {
    ...
    vs8.workspace.registerTextDocumentContentProvider("githd-empty", {
  ...
  openCommittedFile(file) {
    ...
    let left = file.status == "A" ? vs8.Uri.parse("githd-empty:") : toGitUri(file.oldFileUri, leftRef);
    let right = file.status == "D" ? vs8.Uri.parse("githd-empty:") : toGitUri(file.fileUri, rightRef);
    vs8.commands.executeCommand("vscode.diff", left, right, title, { preview: true });
  }
  openCommitInfo() {
...
var Cache = class {
  ...
  countKey(branch, author, startTime, endTime) {
    var _a3, _b2;
    return `${branch},${author != null ? author : ""},${(_a3 = startTime == null ? void 0 : startTime.getTime()) != null ? _a3 : ""},${(_b2 = endTime == null ? void 0 : endTime.getTime()) != null ? _b2 : ""}`;
  }
