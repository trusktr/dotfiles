        ...
        if (color.nodeName === 'ident' && colors_1.colors[color.name]) {
            ...
            try {
                ...
                if (colorPosSet.has(pos)) {
                    ...
                    colorPosSet.add(pos);
                    colorsInformation.push(new vscode_1.ColorInformation(new vscode_1.Range(new vscode_1.Position(color.lineno - 1, exports.getRealColumn(color.raw, text, color.lineno - 1)), new vscode_1.Position(color.lineno - 1, exports.getRealColumn(color.raw, text, color.lineno - 1) + ((_b = color.raw) === null || _b === void 0 ? void 0 : _b.length) || 0)), 
                    // @ts-ignore
