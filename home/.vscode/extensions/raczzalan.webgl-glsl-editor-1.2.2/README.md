...
![syntax highlighting](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/syntax-highlighting.png)
...
![diagnostic](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/diagnostic.png)
...
![offline documentation](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/documentation.png)

### Signature help

The extension can display a signature helper for functions and constructors (except matrix constructors).

![signature help](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/signature-help.png)
...
![code completion](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/completion.png)
...
![before formatting](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/formatting-before.png)

#### After formatting

![after formatting](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/formatting-after.png)
...
![html](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/html.png)

### Rename

You can rename types (and constructors), interface blocks, variables and functions.

![rename](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/rename.png)

### Highlights

The extension can highlight all the occurrences of the selected type, variable function or constructor.

![highlights](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/highlights.png)
...
![hover](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/hover.png)

### Symbols

The extension can provide outline information and breadcrumbs about the types, interface blocks, variables and functions.

![outline and breadcrumbs](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/outline-and-breadcrumbs.png)

You can easily find types, interface blocks, variables and functions.

![find symbol](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/find-symbol.png)
...
![color picker](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/color-picker.png)
...
![call hierarchy](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/call-hierarchy.png)

### Go to/Peek declarations

You can find (go to / peek) the declaration of a type, a variable, a function or a constructor.

![declarations](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/declarations.png)

### Go to/Peek definitions

You can find (go to / peek) the definition of a type, a variable, a function or a constructor.

![definitions](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/definitions.png)

### Go to/Peek type definitions

You can find (go to / peek) the type definition of a variable, a function or a constructor.

![type definitions](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/type-definitions.png)

### Go to/Find all/Peek implementations

You can find (go to / find all / peek) the implementation of a function.

![implementations](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/implementations.png)
...
![references](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/references.png)
...
![before the preprocessor](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/preprocessor-before.png)

#### After the preprocessor

![after the preprocessor](https://github.com/racz16/WebGL-GLSL-Editor/raw/HEAD/res/png/screenshots/preprocessor-after.png)
...
[Detailed build instructions](https://github.com/racz16/WebGL-GLSL-Editor/blob/HEAD/BUILD.md)
