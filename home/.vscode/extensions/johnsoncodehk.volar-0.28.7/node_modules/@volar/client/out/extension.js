...
async function doActivate(context) {
    ...
    docClient = !lowPowerMode ? createLanguageService(context, 'doc', 'volar-document', 'Volar - Document', 6010, languageFeaturesDocumentSelector) : undefined;
    htmlClient = createLanguageService(context, 'html', 'volar-html', 'Volar - HTML', 6011, documentFeaturesDocumentSelector);
...
function createLanguageService(context, mode, id, name, port, documentSelector) {
