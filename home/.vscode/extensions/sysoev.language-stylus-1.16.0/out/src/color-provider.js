        ...
        if (color.nodeName === 'ident' && colors_1.colors[color.name]) {
            ...
            try {
                ...
                if (colorPosSet.has(pos)) {
                    ...
                    colorPosSet.add(pos);
                    colorsInformation.push(new vscode_1.ColorInformation(new vscode_1.Range(new vscode_1.Position(color.lineno - 1, (0, exports.getRealColumn)(color.raw, text, color.lineno - 1)), new vscode_1.Position(color.lineno - 1, (0, exports.getRealColumn)(color.raw, text, color.lineno - 1) + ((_b = color.raw) === null || _b === void 0 ? void 0 : _b.length) || 0)), new vscode_1.Color(
                    // @ts-ignore
                    (0, colors_1.getNumericValue)(color.r, 255.0), 
                    // @ts-ignore
                    (0, colors_1.getNumericValue)(color.g, 255.0), 
                    // @ts-ignore
                    (0, colors_1.getNumericValue)(color.b, 255.0), 1)));
                }
            }
            catch (_) {
                // do nothing
