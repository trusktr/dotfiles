...
class HLSLDocumentSymbolProvider {
    constructor() {
        this._disposables = [];
        this._hlslPattern = ['.hlsl', '.hlsli', '.fx', '.fxh', '.vsh', '.psh', '.cginc', '.compute', '.ush', '.usf'];
        ...
        this._hlslPattern = this._hlslPattern.concat(common_1.hlslExtensions);
            ...
            for (let entry of searchPatterns) {
                ...
                for (let line of lines) {
                    ...
                    if (lineMatch) {
                        ...
                        let filepath = path_1.join(rootPath, lineMatch[1]);
