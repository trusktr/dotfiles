    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const contentChange of this.contentChanges) {
                ...
                if (textDiff.range.start.line === originalLeftBoundary.line) {
                    newStart = position.with(position.line, position.character + textDiff.range.start.character - originalLeftBoundary.character);
                    if (textDiff.range.end.line === originalLeftBoundary.line) {
                        newEnd = position.with(position.line, position.character + textDiff.range.end.character - originalLeftBoundary.character);
                    }
                    else {
                        newEnd = position.with(position.line + textDiff.range.end.line - originalLeftBoundary.line, textDiff.range.end.character);
                    }
                }
                else {
                    newStart = position.with(position.line + textDiff.range.start.line - originalLeftBoundary.line, textDiff.range.start.character);
                    newEnd = position.with(position.line + textDiff.range.end.line - originalLeftBoundary.line, textDiff.range.end.character);
                }
                ...
                if (newLineCount === 1) {
                    ...
                    newRightBoundary = new vscode.Position(newStart.line + newLineCount - 1, textDiff.text.split('\n').pop().length);
                }
                ...
                if (newStart.isEqual(newEnd)) {
                    yield textEditor_1.TextEditor.insert(textDiff.text, position_1.Position.FromVSCodePosition(newStart));
                }
                else {
                    yield textEditor_1.TextEditor.replace(vimState.editor.selection, textDiff.text);
                }
            }
            /**
            ...
            yield vimState.setCurrentMode(mode_1.Mode.Insert);
            return vimState;
        });
    }
}
...
let DisableExtension = class DisableExtension extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            yield vimState.setCurrentMode(mode_1.Mode.Disabled);
            return vimState;
        });
    }
};
...
let CommandInsertWord = class CommandInsertWord extends BaseCommand {
    constructor() {
        super(...arguments);
...
let CommandEsc = class CommandEsc extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            if (vimState.currentMode === mode_1.Mode.Normal && !vimState.isMultiCursor) {
            ...
            if (vimState.currentMode !== mode_1.Mode.Visual &&
                ...
                vimState.currentMode !== mode_1.Mode.EasyMotionMode) {
            ...
            if (vimState.currentMode === mode_1.Mode.SurroundInputMode) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.postponedCodeViewChanges.push({
                ...
                args: {
                    ...
                    value: timesToRepeat,
                    revealCursor: true,
                    select: [mode_1.Mode.Visual, mode_1.Mode.VisualBlock, mode_1.Mode.VisualLine].includes(vimState.currentMode),
                },
            });
            return vimState;
        });
...
class CommandScrollAndMoveCursor extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            const smoothScrolling = configuration_1.configuration.getConfiguration('editor').smoothScrolling;
            ...
            const newPositionLine = util_1.clamp(position.line + (this.to === 'down' ? 1 : -1) * scrollLines, 0, vimState.editor.document.lineCount - 1);
            vimState.cursorStopPosition = new position_1.Position(newPositionLine, vimState.desiredColumn).obeyStartOfLine();
            return vimState;
        });
    }
}
...
let CommandReplaceAtCursorFromNormalMode = class CommandReplaceAtCursorFromNormalMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vimState.setCurrentMode(mode_1.Mode.Replace);
...
let CommandCmdA = class CommandCmdA extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vimState.setCurrentMode(mode_1.Mode.VisualLine);
            return vimState;
        });
    }
};
...
let CommandSearchForwards = class CommandSearchForwards extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vimState.setCurrentMode(mode_1.Mode.SearchInProgressMode);
...
let PutCommand = PutCommand_1 = class PutCommand extends BaseCommand {
    ...
    exec(position, vimState, after = false, adjustIndent = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (typeof register.text === 'object' && vimState.currentMode === mode_1.Mode.VisualBlock) {
            ...
            else if (vimState.currentMode === mode_1.Mode.Visual &&
            ...
            if (vimState.currentMode === mode_1.Mode.Visual ||
                vimState.currentMode === mode_1.Mode.VisualLine ||
                vimState.currentMode === mode_1.Mode.VisualBlock) {
                vimState.lastVisualMode = vimState.currentMode;
                vimState.lastVisualSelectionStart = whereToAddText;
                let textToEnd = textToAdd;
                if (vimState.currentMode === mode_1.Mode.VisualLine && textToAdd[textToAdd.length - 1] === '\n') {
                    // don't go next line
    ...
    execCount(position, vimState) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.effectiveRegisterMode === register_1.RegisterMode.LineWise) {
                result.recordedState.transformations.push({
                    type: 'moveCursor',
                    diff: position_1.PositionDiff.NewBOLDiff(addedLinesCount, 0),
                    cursorIndex: this.multicursorIndex,
                });
            }
            return result;
...
let PutCommandVisual = class PutCommandVisual extends BaseCommand {
    ...
    exec(position, vimState, after = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isLineWise = vimState.currentMode === mode_1.Mode.VisualLine;
...
let CommandShowCommandLine = class CommandShowCommandLine extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vimState.setCurrentMode(mode_1.Mode.CommandlineInProgress);
...
let CommandVisualMode = class CommandVisualMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            yield vimState.setCurrentMode(mode_1.Mode.Visual);
            return vimState;
        });
    }
};
...
function selectLastSearchWord(vimState, direction) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vimState.cursorStartPosition =
            vimState.currentMode === mode_1.Mode.Normal ? result.start : vimState.cursorStopPosition;
...
let CommandVisualBlockMode = class CommandVisualBlockMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            yield vimState.setCurrentMode(mode_1.Mode.VisualBlock);
            return vimState;
        });
    }
};
...
let CommandGoStartPrevOperatedText = class CommandGoStartPrevOperatedText extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.Normal, mode_1.Mode.Visual, mode_1.Mode.VisualLine, mode_1.Mode.VisualBlock];
        this.keys = [
...
CommandGoStartPrevOperatedText = __decorate([
    base_1.RegisterAction
], CommandGoStartPrevOperatedText);
let CommandGoEndPrevOperatedText = class CommandGoEndPrevOperatedText extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.Normal, mode_1.Mode.Visual, mode_1.Mode.VisualLine, mode_1.Mode.VisualBlock];
        this.keys = [
...
CommandGoEndPrevOperatedText = __decorate([
    base_1.RegisterAction
], CommandGoEndPrevOperatedText);
...
let ActionDeleteChar = class ActionDeleteChar extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield state.setCurrentMode(mode_1.Mode.Normal);
            return state;
        });
    }
};
...
let ActionReplaceCharacterVisualBlock = class ActionReplaceCharacterVisualBlock extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const topLeft = mode_1.visualBlockGetTopLeftPosition(vimState.cursorStopPosition, vimState.cursorStartPosition);
...
let ActionChangeChar = class ActionChangeChar extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield state.setCurrentMode(mode_1.Mode.Insert);
            return state;
        });
    }
...
let CommandUnicodeName = class CommandUnicodeName extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.Normal];
        this.keys = ['g', 'a'];
