...
export default class AnnotatedSceneController extends React.Component<IAnnotatedSceneControllerProps, IAnnotatedSceneControllerState> {
	...
	constructor(props) {
		...
		this.utmCoordinateSystem = new UtmCoordinateSystem( this.eventEmitter )
		...
		return (
		  <React.Fragment>
	        ...
	        <LayerManager
				...
				// Looks like we can replace this with a message on a channel (eventEmitter) that
